  ...
  return (
    <View style={styles.container}>
      <Image
        source={{
          uri:
            'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRuqL5v3VYHbNJYWi8M1KwceXLK01c-PB7maW8IiwoEEUHrsHv4&usqp=CAU',
        }}
      ...
      <Text style={styles.title}>
        React Native Web App Skeleton, TS, Jest And GraphQL Ready
      </Text>
